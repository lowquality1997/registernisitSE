...
<div class="container">
    	<center> <form method="post" class="form-signin">
            <h2><img src="img/h3.jpg" alt="h3" style="width:30%;max-width:150px"><class="form-signin-heading">สมัครสมาชิก</h2><hr />
			<img src="img/h2.jpg" alt="h2" style="width:80%;max-width:400px"></center>
            <?php
			if(isset($error))
			{
